// Combined front plate and GoPro two-blade mount, modeled with editable CSG primitives.
// Created as a new v1 combined part from front_plate_mount_v1.scad and gopro_mount_2blade_v1.scad.
...
module front_plate_gopro_mount_v1() {
    union() {
        front_plate();

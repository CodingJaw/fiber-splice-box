...
end_circle_diameter = 40.00; // [10:0.1:80]
...
pad_style = "Raised"; // [Raised, Lowered, Flush]
// Diameter of the raised/lowered circular pad area.
pad_diameter = 24.00; // [6:0.1:70]
...
counterbore_style = "None"; // [None, Raised side, Lowered side]
// Counterbore diameter for screw head clearance.
counterbore_diameter = 6.20; // [4:0.1:12]
// Counterbore depth.

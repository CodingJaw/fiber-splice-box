...
thread_preset = "Custom"; // [Custom, 1/4-20 UNC, 1/4-28 UNF, M6x1, M8x1.25, M10x1.5, M12x1.75]
thread_units = "TPI"; // [TPI, Metric pitch mm]

/* [Custom Thread Settings] */
custom_major_d = 23.0; // [16:0.1:28]
custom_tpi = 20; // [8:1:40]
custom_pitch_mm = 1.25; // [0.5:0.05:3]
custom_thread_depth = 0.72; // [0.2:0.01:1.6]
thread_length = 6.0; // [2:0.1:12]

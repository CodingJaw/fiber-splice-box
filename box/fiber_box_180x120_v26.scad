/*
  Fiber box base - SC holder centered - stacked print layout - 180x120 V26
...
module blue_hinge_sealing_surface_relief_cut() {
    if (AddBlueWedgeBoxHinge && BlueHingeReliefAboveSplit) {
        ...
        translate([0, cut_center_y, cut_center_z])
            cube([blue_hinge_span + 8, cut_depth_y, cut_height_z], center=true);
    }
}

/*
  Fiber box base - SC holder centered - stacked print layout
  Current requested outside case size:
    Caselength = 120 mm
    CaseWidth  = 80 mm
    CaseHeight = 40 mm

  Use the long 120 mm side as the vertical/upright direction for layout.
  ...
  Added in this version:
    ...
    - SC adapter ends point along the 120 mm case length.
...
// This keeps the 120 mm long side pointing the same direction for both pieces.
...
// X = 120 mm long box direction. The SC connector ends point along X.
...
// X = 120 mm long upright direction.
...
// Hole/post placement.
// Two cable entries are centered on the lower short wall, separated along the 80 mm width.
...
//   - hinge pin/hole axis runs along X, the 120 mm long direction
...
// Raise/lower the hinge inside the bottom half here.
// V10: raised so the top of the hinge barrel/wedge is level with the bottom-box opening.
blue_axis_z              = (CaseHeight - CutFromTop) - blue_knuckle_od/2;

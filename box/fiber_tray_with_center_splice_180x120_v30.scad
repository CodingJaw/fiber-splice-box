/*
  Fiber Tray With Centered MID-FLEX Oval Fiber Holder + Straight 4-Splice Holder 180x120 V30
...
Second_Inner_Racetrack_Fingers = true; // [true,false]
// Applies the same fiber keepout cut to the second inner racetrack.
Second_Inner_Racetrack_Keepout = true; // [true,false]

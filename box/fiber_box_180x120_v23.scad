/*
  Fiber box base - SC holder centered - stacked print layout - 180x120 V23
...
BlueHingeHeightPreset     = "Flush with opening"; // [Lower - 6mm, Lower - 3mm, Flush with opening, Raise +3mm, Custom numeric offset]
...
blue_axis_z              = (CaseHeight - CutFromTop) - blue_knuckle_od/2 + blue_hinge_z_offset;
...
echo(str("Blue hinge spacing preset: ", BlueHingeSpacingPreset,
         ...
         "; hinge wall Z offset = ", blue_hinge_z_offset, " mm",
         "; hinge axis Z = ", blue_axis_z, " mm"));

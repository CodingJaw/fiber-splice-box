// v1-20: 1/4-20 bolt and 6 mm thick matching nut.
// Units: millimeters. Parts sit flat on the build plate at Z=0.
...
bolt_fit_clearance = 0.25;              // undersize printed bolt thread so it fits a metal 1/4-20 nut
...
module quarter_20_nut() {
    difference() {
        ...
        threaded_hole_cutter(
            bolt_major_diameter + nut_cutter_clearance,
            bolt_minor_diameter + nut_cutter_clearance + nut_thread_clearance,
            nut_thickness,
            thread_pitch
        );
    }

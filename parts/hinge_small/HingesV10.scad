...
//
// V10 inverts the hinge-base relief placement so each leaf is relieved for the opposite side barrel pattern.
        ...
        union() {
            difference() {
                ...
                if (right_base_relief_enabled) {
                    base_relief_cut(-barrel_total_length / 2, 1, left_outer_barrel_length, right_base_relief_depth, right_base_relief_corner_radius, right_base_relief_square_amount, right_leaf_thickness);
                    base_relief_cut(barrel_total_length / 2 - left_outer_barrel_length, 1, left_outer_barrel_length, right_base_relief_depth, right_base_relief_corner_radius, right_base_relief_square_amount, right_leaf_thickness);
                }
            }

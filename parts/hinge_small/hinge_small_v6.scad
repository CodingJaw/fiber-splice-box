// Small hinge, version 6.
//
// Fully procedural OpenSCAD model based on measurements from the original V1
// STL files. V6 refines the spacer into an adjustable shaft, head, and
// screw-hole model without importing STL geometry.

$fn = 96;

/* [View] */

show_part = "assembly"; // [assembly: Assembly, exploded: Exploded, left_hinge: Left hinge, right_hinge: Right hinge, spacer: Spacer, cap: End cap]
exploded_spacing = 28;
...
// Shaft diameter applies to the entire non-head shaft.
spacer_shaft_diameter = 12.6;
spacer_shaft_length = 35.65;
spacer_x_start = -17.85;

// Head diameter and thickness at the far end of the spacer.
spacer_head_diameter = 12.6;
spacer_head_thickness = 2.45;

// Screw hole in the shaft end opposite the head, used to retain the cap.

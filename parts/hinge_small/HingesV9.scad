...
//
// V9 adds configurable hinge-base barrel relief cutouts, support webs, and a bore-safe spacer shaft.
        ...
        union() {
            difference() {
                ...
                if (left_base_relief_enabled) {
                    base_relief_cut(-barrel_total_length / 2, -1, left_outer_barrel_length, left_base_relief_depth, left_base_relief_corner_radius, left_base_relief_square_amount, left_leaf_thickness);
                    base_relief_cut(barrel_total_length / 2 - left_outer_barrel_length, -1, left_outer_barrel_length, left_base_relief_depth, left_base_relief_corner_radius, left_base_relief_square_amount, left_leaf_thickness);
                }
            }
        ...
        union() {
            difference() {
                ...
                if (right_base_relief_enabled) {
                    base_relief_cut(-right_center_barrel_length / 2, 1, right_center_barrel_length, right_base_relief_depth, right_base_relief_corner_radius, right_base_relief_square_amount, right_leaf_thickness);
                }
            }

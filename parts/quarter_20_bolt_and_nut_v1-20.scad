// v1-20: 1/4-20 bolt, 1 inch long, with a 6 mm thick threaded nut.
// Units: millimeters.
...
// Keep the modeled bolt root near the middle of that range and use a small
// extra allowance on the nut cutter so printed parts have a chance to fit.
bolt_minor_diameter = 4.90;
thread_depth = (bolt_major_diameter - bolt_minor_diameter) / 2;
